...
public class ReleaseCallMessageProcessorDebuggable
    extends ReleaseCallMessageProcessor
    implements DebugInfoProvider
{


    public ReleaseCallMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("call", "Call", (java.lang.String.class), call, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("agentInstrument", "Agent instrument", (java.lang.String.class), agentInstrument, muleEvent));
