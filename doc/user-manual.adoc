...
To use the CDC Software Platform Connector you must have in-place an installation of the CDC Platform.  For additional system support information, visit the link:release-notes[CDC Software Platform Connector Release Notes].
...
* Access the link:./CDC_Platform_Mulesoft_User_Guide.docx[CDC Software Platform Connector Release Notes].
