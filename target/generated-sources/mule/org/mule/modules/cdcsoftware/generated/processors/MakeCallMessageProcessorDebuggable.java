...
public class MakeCallMessageProcessorDebuggable
    extends MakeCallMessageProcessor
    implements DebugInfoProvider
{


    public MakeCallMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("agentId", "Agent id", (java.lang.String.class), agentId, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("phoneNumber", "Phone number", (java.lang.String.class), phoneNumber, muleEvent));
