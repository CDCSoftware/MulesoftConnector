...
package org.mule.modules.cdcsoftware.generated.sources;
...
/**
 * GetEventsMessageSource wraps {@link org.mule.modules.cdcsoftware.CDCSoftwareConnector#getEvents(org.mule.api.callback.SourceCallback)} method in {@link CDCSoftwareConnector } as a message source capable of generating Mule events.  The POJO's method is invoked in its own thread.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-04-17T10:57:30-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class GetEventsMessageSource
    ...
    implements Runnable, FlowConstructAware, MuleContextAware, Startable, Stoppable, MessageSource
{
    ...
    public GetEventsMessageSource(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((CDCSoftwareConnector) object).getEvents(sourceCallback);
                    return null;
                }
